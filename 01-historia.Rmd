...
# Introdução histórica daquilo que veio a se chamar estatística {#introducao-historica-daquilo-que-veio-a-se-chamar-estatistica}

\

Neste capítulo, exploraremos a transição da estatística de uma ferramenta de registro estatal para uma ciência de suporte à decisão. 

\


<iframe src="assets\introducao.html" width="100%" height="500px" style="border:none;"></iframe>
