...
# Introdução conceitual essencial{#introducao-conceitual-essencial}

\

Neste capítulo, estabeleceremos as bases operacionais da estatística, diferenciando os universos populacionais de suas representações amostrais e definindo a natureza das variáveis e notações matemáticas essenciais.

\


<iframe src="assets\conceitos.html" width="100%" height="500px" style="border:none;"></iframe>
