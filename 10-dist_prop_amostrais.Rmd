...
IC_{[\Pi, (1-\alpha)]} = \left[\, 0 \;,\; \hat{p} + z_{\alpha} \cdot \sqrt{\frac{\hat{p}\left(1-\hat{p}\right)}{n}} \,\right]
$$
...
IC_{[\Pi, (1-\alpha)]} = \left[\, \hat{p} - z_{\alpha} \cdot \sqrt{\frac{\hat{p}\left(1-\hat{p}\right)}{n}} \;,\; 1 \,\right]
$$
...
$$
P\left[(\Pi_{X}-\Pi_{Y}) \le (\hat{p}_{X}-\hat{p}_{Y}) + z_{\alpha} \cdot \sqrt{\frac{\hat{p}_{X}(1-\hat{p}_{X})}{n_{X}}+ \frac{\hat{p}_{Y}(1-\hat{p}_{Y})}{n_{Y}}}\right] = (1-\alpha)\\
IC_{[(\Pi_X - \Pi_Y),\,(1-\alpha)]} = \left[\, -1 \;,\; (\hat{p}_{X}-\hat{p}_{Y}) + z_{\alpha} \cdot \sqrt{\frac{\hat{p}_{X}(1-\hat{p}_{X})}{n_{X}}+ \frac{\hat{p}_{Y}(1-\hat{p}_{Y})}{n_{Y}}} \,\right]
$$ 
...
$$
P\left[(\Pi_{X}-\Pi_{Y})  \hspace{0.1cm} \ge \hspace{0.1cm} (\hat{p}_{X}-\hat{p}_{Y}) - {z}_{\alpha} \cdot \sqrt{{\frac{\hat{p}_{X}(1-\hat{p}_{X})}{n_{X}}+ \frac{\hat{p}_{Y}(1-\hat{p}_{Y})}{n_{Y}}}}\right] = (1-\alpha)\\
IC_{[(\Pi_X - \Pi_Y), (1-\alpha)]} = \left[ (\hat{p}_{X}-\hat{p}_{Y}) - z_{\alpha} \cdot \sqrt{\frac{\hat{p}_{X}(1-\hat{p}_{X})}{n_{X}}+ \frac{\hat{p}_{Y}(1-\hat{p}_{Y})}{n_{Y}}} \;,\; 1 \right]
$$
