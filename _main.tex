...
\author{}
\date{\vspace{-2.5em}Londrina, 21 de janeiro de 2023.}
...
\caption{Calculadora Cassio}\label{fig:unnamed-chunk-26}
\end{figure}
...
\caption{John Tukey (1915-2000)}\label{fig:unnamed-chunk-28}
\end{figure}
...
\caption{Gráfico de dispersão unidimensional (stripchart)}\label{fig:unnamed-chunk-32}
\end{figure}
...
\caption{Mudanças na média pela adição (subtração) de uma constante $k=0.05$}\label{fig:unnamed-chunk-33}
\end{figure}
...
\caption{Mudanças na média pela multiplicação (divisão) de uma constante $k=1.2$}\label{fig:unnamed-chunk-34}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-36}Bimodal: 1,66 m e 1,73 m}
\end{figure}
...
\caption{Valores observados das alturas dos estudantes e as posições da média, moda e mediana}\label{fig:unnamed-chunk-40}
\end{figure}
...
\caption{Histograma das alturas dos estudantes com as posições da média, moda e mediana}\label{fig:unnamed-chunk-41}
\end{figure}
...
\caption{Quadro comparativo entre as medidas de tendência central (posição)}\label{fig:unnamed-chunk-42}
\end{figure}
...
{\centering \includegraphics{_main_files/figure-latex/unnamed-chunk-47-1} 

}

\caption{Histograma de uma variável com Distribuição Normal (média 20 e variãncia 5}\label{fig:unnamed-chunk-47}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{_main_files/figure-latex/unnamed-chunk-48-1} 

}

\caption{Diferentes formas na distribuição dos dados}\label{fig:unnamed-chunk-48}
\end{figure}
...
\caption{Diferentes aspectos de uma distribuição quanto à sua inclinação}\label{fig:unnamed-chunk-49}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-50}Gráfico de barras dos dados brutos: uma barra para cada observação e sua altura expressando o número de observações com esse valor}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-51}Histograma das alturas dos estudantes. Uma barra para cada classe de altura e sua altura expressando a quantidade de observações com valores dentro dessa classe (intencionalmente criamos duas classe sem nenhuma observação)}
\end{figure}
...
{\centering \includegraphics{_main_files/figure-latex/unnamed-chunk-53-1} 
...
\caption{\label{fig:unnamed-chunk-54}Histograma das alturas dos estudantes. Uma barra para cada classe de altura e sua altura expressando a quantidade de observações com valores dentro dessa classe (intencionalmente criamos duas classe sem nenhuma observação)}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-55}A linha vermelha é uma aproximação da Função de Densidade da frequência relativa de observação (a linhe preta é a curva da função densidade de uma distribuição Normal com média e variâncias dadas pelos dados}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-57}Gráfico de barras}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-58}Gráfico de setores}
\end{figure}
...
\caption{Representação gráfico do espaço amostral do experimento aleatório e do evento de interesse definido}\label{fig:unnamed-chunk-60}
\end{figure}
...
\caption{Diagrames de Venn}\label{fig:unnamed-chunk-61}
\end{figure}
...
\caption{União: $A \cup B$}\label{fig:unnamed-chunk-62}
\end{figure}
...
\caption{Interseção: $A \cap B$}\label{fig:unnamed-chunk-63}
\end{figure}
...
\caption{Complementar  $A^{c}$}\label{fig:unnamed-chunk-64}
\end{figure}
...
\caption{Complementar de B}\label{fig:unnamed-chunk-65}
\end{figure}
...
\caption{Astralagus (um dos ossos que compõem o calcanhar, usado no Egito antigo como um dado rudimentar)}\label{fig:unnamed-chunk-66}
\end{figure}
...
Consideremos o exemplo do experimento que consiste em se lançar um dado e observar o valor numérico de sua face. As suposições que deveriam ser estabelecidas \textit{a priori} são:
...
\caption{Representação gráfica da função $P(\Omega)$}\label{fig:unnamed-chunk-67}
\end{figure}
...
\caption{Andrey Nikolaevich Kolmogorov  (1903-1987)}\label{fig:unnamed-chunk-68}
\end{figure}
...
\caption{Diagrama de Venn do espaço amostral}\label{fig:unnamed-chunk-69}
\end{figure}
...
E seja \textit{B} um evento qualquer em \(\Omega\) como ilustrado na Figura \ref{fig:fig8}
