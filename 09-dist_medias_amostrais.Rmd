...
# Introdução à distribuição das médias e diferenças entre médias e seus intervalos de confiança{#introducao-a-distribuicao-das-medias-e-diferencas-entre-medias-e-seus-intervalos-de-confianca}
...
### Intervalos de confiança para a média de uma população Normal com variância conhecida (Figura \@ref(fig:fig28))
...
### Intervalos de confiança para a média de uma população Normal de variância desconhecida mas amostra não tão pequena: $n \ge 30$  (Figura \@ref(fig:fig55))
...
### Intervalos de confiança para a média de uma população Normal com variância desconhecida e amostra de qualquer tamanho (Figura \@ref(fig:fig58))
...
```{r , echo=FALSE, out.width='70%', fig.align='center', fig.cap='Fluxograma auxiliar para a construção de intervalos de confiança para $\\mu$.'}

knitr::include_graphics("images9/fluxograma_IC_media.png")
...
## Distribuição das diferenças das médias de duas populações Normais e seus intervalos de confiança
...
### Intervalos de confiança para a diferença das médias de duas populações Nomrais de variâncias conhecidas e amostras independentes de qualquer tamanho 
...
### Intervalos de confiança para a diferença das médias de duas populações Normais de variâncias desconhecidas e amostras independentes grandes
...
### Intervalos de confiança para a diferença das médias de duas populações Normais de variâncias desconhecidas mas iguais 
...
### Intervalos de confiança para a diferença das médias de duas populações Normais de variâncias desconhecidas e desiguais
...
\begin{align*}
P[(\stackrel{-}{x}-\stackrel{-}{y} ) -   ({t}_{( \nu, 1-\frac{\alpha }{2})} \cdot   \sqrt{\frac{S^{2}_{1}}{n_{1}} + \frac{S^{2}_{2}}{n_{2}} }  ) \le (\mu_{1}-\mu_{2}) \le (\stackrel{-}{x}-\stackrel{-}{y})   +({t}_{( \nu, 1-\frac{\alpha }{2})} \cdot  \sqrt{\frac{S^{2}_{1}}{n_{1}} + \frac{S^{2}_{2}}{n_{2}} }        )     ] & = (1-\alpha) \\
P[ 4  -   ( 2,44  \cdot   \sqrt{\frac{ 2}{4} + \frac{14,40}{6}}  ) \le (\mu_{1}-\mu_{2}) \le  4  +( 2,44  \cdot  \sqrt{\frac{ 2}{4} + \frac{14,40}{6}}        )     ] & = 0,95 \\
P[ 4  -   ( 2,44  \cdot   1,70   ) \le (\mu_{1}-\mu_{2}) \le  4  +( 2,44  \cdot  1,70   )     ] &  = 0,95 \\
P[ 4  - 4,15  \le (\mu_{1}-\mu_{2}) \le  4  + 4,15  )     ] & = 0,95 \\
\end{align*}
...
## Distribuição das diferenças das médias de duas populações Normais com médias não independentes e seus intervalos de confiança
...
```{r , echo=FALSE, out.width='70%', fig.align='center', fig.cap='Fluxograma auxiliar para a construção de intervalos de confiança para $\\mu_{1}-\\mu_{2}$.'}

knitr::include_graphics("images9/fluxograma_IC_dif_media.png")
