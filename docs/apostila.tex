...
\author{}
\date{\vspace{-2.5em}Londrina, 27 de janeiro de 2023.}
...
A enfermeira inglesa Florence Nightingale (1820-1910) conduziu um trabalho pioneiro ao chegar no hospital militar britânico na Turquia em 1856, estabelecendo uma ordem e um método muito necessários aos registros médicos estatísticos e que indicaram serem as precárias práticas sanitárias o culpado da alta mortalidade \href{https://www.york.ac.uk/depts/maths/histstat/small.htm,\%20Figuras\%20\ref{fig:figA12}\%20e\%20\ref{fig:figA13}}{(link)}.
...
\caption{Augustus De Morgan (1806 - 1871)}\label{fig:unnamed-chunk-8}
\end{figure}
...
\caption{Calculadora Cassio}\label{fig:unnamed-chunk-9}
\end{figure}
...
\caption{John Tukey (1915-2000)}\label{fig:unnamed-chunk-11}
\end{figure}
...
{\centering \includegraphics{apostila_files/figure-latex/unnamed-chunk-15-1} 

}

\caption{Gráfico de dispersão unidimensional (stripchart)}\label{fig:unnamed-chunk-15}
\end{figure}
...
{\centering \includegraphics{apostila_files/figure-latex/unnamed-chunk-16-1} 

}

\caption{Mudanças na média pela adição (subtração) de uma constante $k=0.05$}\label{fig:unnamed-chunk-16}
\end{figure}
...
{\centering \includegraphics{apostila_files/figure-latex/unnamed-chunk-17-1} 

}

\caption{Mudanças na média pela multiplicação (divisão) de uma constante $k=1.2$}\label{fig:unnamed-chunk-17}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{apostila_files/figure-latex/unnamed-chunk-19-1.pdf}
\caption{\label{fig:unnamed-chunk-19}Bimodal: 1,66 m e 1,73 m}
\end{figure}
...
{\centering \includegraphics{apostila_files/figure-latex/unnamed-chunk-23-1} 

}

\caption{Valores observados das alturas dos estudantes e as posições da média, moda e mediana}\label{fig:unnamed-chunk-23}
\end{figure}
...
{\centering \includegraphics{apostila_files/figure-latex/unnamed-chunk-24-1} 

}

\caption{Histograma das alturas dos estudantes com as posições da média, moda e mediana}\label{fig:unnamed-chunk-24}
\end{figure}
...
\caption{Quadro comparativo entre as medidas de tendência central (posição)}\label{fig:unnamed-chunk-25}
\end{figure}
...
{\centering \includegraphics{apostila_files/figure-latex/unnamed-chunk-30-1} 

}

\caption{Histograma de uma variável com Distribuição Normal (média 20 e variãncia 5}\label{fig:unnamed-chunk-30}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{apostila_files/figure-latex/unnamed-chunk-31-1} 

}

\caption{Diferentes formas na distribuição dos dados}\label{fig:unnamed-chunk-31}
\end{figure}
...
\caption{Diferentes aspectos de uma distribuição quanto à sua inclinação}\label{fig:unnamed-chunk-32}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{apostila_files/figure-latex/unnamed-chunk-33-1.pdf}
\caption{\label{fig:unnamed-chunk-33}Gráfico de barras dos dados brutos: uma barra para cada observação e sua altura expressando o número de observações com esse valor}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{apostila_files/figure-latex/unnamed-chunk-34-1.pdf}
\caption{\label{fig:unnamed-chunk-34}Histograma das alturas dos estudantes. Uma barra para cada classe de altura e sua altura expressando a quantidade de observações com valores dentro dessa classe (intencionalmente criamos duas classe sem nenhuma observação)}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{apostila_files/figure-latex/unnamed-chunk-35-1.pdf}
\caption{\label{fig:unnamed-chunk-35}Gráfico de setores das alturas dos estudantes}
\end{figure}
...
\caption{Box-plot de um rol de valores com Distribuição Normal (média 20 e variãncia 5}\label{fig:unnamed-chunk-36}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-37}Histograma das alturas dos estudantes. Uma barra para cada classe de altura e sua altura expressando a quantidade de observações com valores dentro dessa classe (intencionalmente criamos duas classe sem nenhuma observação)}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{apostila_files/figure-latex/unnamed-chunk-38-1.pdf}
\caption{\label{fig:unnamed-chunk-38}A linha vermelha é uma aproximação da Função de Densidade da frequência relativa de observação (a linhe preta é a curva da função densidade de uma distribuição Normal com média e variâncias dadas pelos dados}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-40}Gráfico de barras}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-41}Gráfico de setores}
\end{figure}
...
\caption{Representação gráfico do espaço amostral do experimento aleatório e do evento de interesse definido}\label{fig:unnamed-chunk-43}
\end{figure}
...
\caption{Diagramas de Venn}\label{fig:unnamed-chunk-44}
\end{figure}
...
\caption{União: $A \cup B$}\label{fig:unnamed-chunk-45}
\end{figure}
...
\caption{Interseção: $A \cap B$}\label{fig:unnamed-chunk-46}
\end{figure}
...
\caption{Complementar  $A^{c}$}\label{fig:unnamed-chunk-47}
\end{figure}
...
\caption{Complementar de B}\label{fig:unnamed-chunk-48}
\end{figure}
...
\caption{Astralagus (um dos ossos que compõem o calcanhar, usado no Egito antigo como um dado rudimentar)}\label{fig:unnamed-chunk-49}
\end{figure}
...
\caption{Representação gráfica da função $P(\Omega)$}\label{fig:unnamed-chunk-50}
\end{figure}
...
\caption{Andrey Nikolaevich Kolmogorov  (1903-1987)}\label{fig:unnamed-chunk-51}
\end{figure}
...
\caption{Independência implica em ausência de qualquer tipo de associação (a recíproca não se aplica}\label{fig:unnamed-chunk-52}
\end{figure}
...
\caption{Thomas Bayes (1702 - 1761)}\label{fig:unnamed-chunk-53}
\end{figure}
...
\caption{Ilustração do experimento aleatório sob a condição de reposição}\label{fig:unnamed-chunk-54}
\end{figure}
...
\caption{Ilustração do experimento aleatório sob a condição de não reposição}\label{fig:unnamed-chunk-55}
\end{figure}
...
\caption{Função discreta de distribuição de probabilidade}\label{fig:unnamed-chunk-59}
\end{figure}
...
\caption{xxxxxxxxxxxx}\label{fig:unnamed-chunk-63}
\end{figure}
...
\caption{Diferentes espaços amostrais de um experimento aleatório (por razões gráficas desprezem o espaço fora dos círculos}\label{fig:unnamed-chunk-64}
\end{figure}
...
\caption{xxxxxxxxxxxxxxxxxxx}\label{fig:unnamed-chunk-65}
\end{figure}
...
\caption{xxxxxxxxxxxxxxxxxxx}\label{fig:unnamed-chunk-66}
\end{figure}
...
\caption{xxxxxxxxxxxxxxxx}\label{fig:unnamed-chunk-67}
\end{figure}
...
{\centering \includegraphics{apostila_files/figure-latex/unnamed-chunk-75-1} 

}

\caption{Curva da fdp da Distribuição Normal padronizada mostrando as áreas delimitadas pelo score z arbitrado (1,64)}\label{fig:unnamed-chunk-75}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth]{images7/esquema} 

}

\caption{Representação esquemática do fluxo de infomações da amostra à produção de conhecimento }\label{fig:unnamed-chunk-78}
\end{figure}
...
\begin{quote}
Exemplo:
objetivo geral: estabelcer o perfil dos estudantes universitários de Londrina
objetivos específicos: conhecer a renda média familiar e cidade de origem
...
{\centering \includegraphics[width=0.5\linewidth]{images7/amostragem} 

}

\caption{Principais procedimentos para se extrair uma amostra}\label{fig:unnamed-chunk-80}
\end{figure}

\hfill\break

\hypertarget{amostragem-probabiluxedstica}{%
\subsection{Amostragem probabilística}\label{amostragem-probabiluxedstica}}
...
\subsubsection{Amostragem aleatória simples (AAS)}\label{amostragem-aleatuxf3ria-simples-aas}}
...
Ou enumerar cada um dos elementos da lista de possibilidades atribuindo um número a cada um e, em seguida, usar uma tabela de números aleatórios (ou um programa computacional para sua geração) para a escolha dos elementos que integrarão a amostra.
