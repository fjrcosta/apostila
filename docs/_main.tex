...
\hypersetup{
  pdftitle={Apostila de estatística},
  hidelinks,
...
\chapter{Primeiros levantamentos, estudos e publicações \& Demografia e aritmética política}\label{primeiros-levantamentos-estudos-e-publicauxe7uxf5es-demografia-e-aritmuxe9tica-poluxedtica}}

1086

O \emph{Domesday Book} \(\href{http://www.nationalarchives.gov.uk/education/resources/domesday-book/}{(link)}\) foi encomendado em dezembro de 1085 por Guilherme, o Conquistador (\emph{King William I}), que invadiu a Inglaterra em 1066.
...
\caption{Domesday Book}\label{fig:unnamed-chunk-4}
\end{figure}
...
\caption{Natural and Political Observations Mentioned in a Following Index and Made upon the Bills of Mortality (ed. de 1662)}\label{fig:unnamed-chunk-5}
\end{figure}
...
\caption{Several Essays in Political Arithmetick (ed. de 1699)}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{Halley’s life table (1693)}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{Abriß der neuen Staatswissenschaft der vornehmen Europäischen Reiche und Republiken (1749)}\label{fig:unnamed-chunk-8}
\end{figure}
...
\caption{The Elements of Universal Erudition  (1771)}\label{fig:unnamed-chunk-9}
\end{figure}
...
\caption{The Pyramid of Statistical Enquiry  (1814)}\label{fig:unnamed-chunk-10}
\end{figure}
...
\caption{Mapa dos casos de cólera (1854)}\label{fig:unnamed-chunk-11}
\end{figure}

\hypertarget{visualizauxe7uxe3o-de-dados-estudos-e-primeiras-publicauxe7uxf5es}{%
\chapter{Visualização de dados \& Estudos e primeiras publicações}\label{visualizauxe7uxe3o-de-dados-estudos-e-primeiras-publicauxe7uxf5es}}
...
\caption{Expectativa de vida de diversas pessoas (1765)}\label{fig:unnamed-chunk-12}
\end{figure}
...
\caption{Commercial and Political Atlas (Atlas Comercial e Político de 1786): cada barra representa as exportações e importações da Escócia para 17 países em 1781}\label{fig:unnamed-chunk-13}
\end{figure}
...
\caption{Statistical Breviary (Breviário Estatístico de 1801): proporção da extensão do Império Turco em diferentes regiões do mundo: Asia, Europa e África, antes de 1789}\label{fig:unnamed-chunk-14}
\end{figure}
...
\caption{Gráfico de barras de Florence Nightingale mostrando as diferenças de mortalidade entre soldados britânicos e a população masculina inglesa geral (civis)}\label{fig:unnamed-chunk-16}
\end{figure}

\hypertarget{pioneiros}{%
\chapter{Pioneiros}\label{pioneiros}}
...
\chapter{Revista Biometrika}\label{revista-biometrika}}
...
\emph{Sir} Francis Galton, que serviu como editor da primeira edição (1901), escreveu a Introdução, que incluiu uma declaração de propósito para a revista \(\href{https://academic.oup.com/biomet/article-abstract/1/1/1/192192?redirectedFrom=fulltext}{(link)}\).

\hypertarget{eugenia}{%
\chapter{Eugenia}\label{eugenia}}
...
\caption{Gráfico de linhagens para alergias}\label{fig:unnamed-chunk-17}
\end{figure}
...
\caption{Gráfico de linhagens para aptidão musical}\label{fig:unnamed-chunk-18}
\end{figure}
...
\caption{Linhas "normais" e "degeneradas" da família Kallikak (New Jersey)}\label{fig:unnamed-chunk-19}
\end{figure}
...
\caption{Lei da Inegridade Racia (Virginia, EUA, 1924)}\label{fig:unnamed-chunk-20}
\end{figure}
...
\caption{Licença para casamento}\label{fig:unnamed-chunk-21}
\end{figure}
