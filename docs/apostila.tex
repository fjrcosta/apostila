...
\author{}
\date{\vspace{-2.5em}Londrina, 08 de fevereiro de 2023.}
...
\FunctionTok{barplot}\NormalTok{(tab\_desembarque,}
        \AttributeTok{main=}\StringTok{"Fig. 01: Desembarques no terminal internacional A em Cumbica (SP, Brasil) }\SpecialCharTok{\textbackslash{}n}\StringTok{(10/10/2021: 8 h 00min às 12 h 00 min)"}\NormalTok{,}
...
\caption{\label{fig:unnamed-chunk-41}Gráfico de barras dos dados observados no terminal de desembarque internacional do aeroporto}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-42}Gráfico de setores das alturas dos estudantes}
\end{figure}
...
Com \(c=0,08m\) as classes ficam assim estabelecidas, tendo-se como ponto de partida o valor mínimo observado: 1,41 m - 1,49 m; 1,49 m - 1,57 m; 1,57 m - 1,65 m; 1,65 m - 1,73 m; 1,73 m - 1,81 m; 1,81 m - 1,89 m; 1,89 m - 2,01 m.
...
A tabela de distribuição de frequências assume a forma:
...
1 & 1,41 \(\vdash\) 1,51 & 1,46 & 3 & 0,05 & 5 & 3 & 5 \\
2 & 1,51 \(\vdash\) 1,61 & 1,56 & 8 & 0,13 & 13,33 & 11 & 18,33 \\
3 & 1,61 \(\vdash\) 1,71 & 1,66 & 23 & 0,38 & 38,34 & 34 & 56,57 \\
4 & 1,71 \(\vdash\) 1,81 & 1,76 & 17 & 0,28 & 28,33 & 51 & 84,87 \\
5 & 1,81 \(\vdash\) 1,91 & 1,86 & 6 & 0,10 & 10 & 57 & 94,57 \\
6 & 1,91 \(\vdash\) 2,01 & 1,96 & 3 & 0,05 & 5 & 60 & 99,87 \\
...
\caption{\label{fig:unnamed-chunk-49}Histograma das alturas dos estudantes. Uma barra para cada classe de altura e sua altura expressando a quantidade de observações com valores dentro dessa classe}
\end{figure}
...
{\centering \includegraphics{apostila_files/figure-latex/unnamed-chunk-53-1} 
...
\caption{xxxxxxxxxxxx}\label{fig:unnamed-chunk-75}
\end{figure}
...
\caption{xxxxxxxxxxxxxxxxxxx}\label{fig:unnamed-chunk-77}
\end{figure}
...
\caption{xxxxxxxxxxxxxxxxxxx}\label{fig:unnamed-chunk-78}
\end{figure}
...
\caption{xxxxxxxxxxxxxxxx}\label{fig:unnamed-chunk-79}
\end{figure}
