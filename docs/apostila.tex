...
\caption{Representação gráfica da função $P(\Omega)$}\label{fig:unnamed-chunk-57}
\end{figure}
...
\caption{Andrey Nikolaevich Kolmogorov  (1903-1987)}\label{fig:unnamed-chunk-58}
\end{figure}
...
\caption{Independência implica em ausência de qualquer tipo de associação (a recíproca não se aplica}\label{fig:unnamed-chunk-59}
\end{figure}
...
\caption{Thomas Bayes (1702 - 1761)}\label{fig:unnamed-chunk-60}
\end{figure}
...
\caption{Ilustração do experimento aleatório sob a condição de reposição}\label{fig:unnamed-chunk-61}
\end{figure}
...
\caption{Ilustração do experimento aleatório sob a condição de não reposição}\label{fig:unnamed-chunk-62}
\end{figure}
...
\caption{Função discreta de distribuição de probabilidade}\label{fig:unnamed-chunk-66}
\end{figure}
...
\caption{Diferentes espaços amostrais de um experimento aleatório (por razões gráficas desprezem o espaço fora dos círculos}\label{fig:unnamed-chunk-71}
\end{figure}
...
\caption{xxxxxxxxxxxxxxxxxxx}\label{fig:unnamed-chunk-73}
\end{figure}
...
\caption{xxxxxxxxxxxxxxxx}\label{fig:unnamed-chunk-74}
\end{figure}
