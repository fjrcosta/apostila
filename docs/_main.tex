...
{\centering \includegraphics{_main_files/figure-latex/unnamed-chunk-48-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{_main_files/figure-latex/unnamed-chunk-49-1} 
...
{\centering \includegraphics{_main_files/figure-latex/unnamed-chunk-54-1} 
...
\caption{Independência implica em ausência de qualquer tipo de associação (a recíproca não se aplica}\label{fig:unnamed-chunk-71}
\end{figure}
